...
\begin{document}
  ...
  \begin{frame}
    \frametitle{WaveNet: Complete Architecture}
    \begin{figure}
      \includegraphics[scale=0.25]{images/wavenet_comp_arch.png}
      \caption{Putting all the pieces together\footfullcite{medium_kion_kim}}
    \end{figure}
  \end{frame}
