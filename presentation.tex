      ...
      \begin{columns}
        \column{0.3\textwidth}
          ...
          \begin{itemize}
            ...
            \item Database has to be changed for every new style
          \end{itemize}
        ...
        \column{0.3\textwidth}
          ...
          \textbf{Parametric}\\
          \begin{itemize}
            \item Simulate human voice using a parametric physical model
            \item Easy to modify voice
          \end{itemize}
        ...
        \column{0.3\textwidth}
          ...
          \begin{itemize}
            ...
            \item More natural sounding output
          \end{itemize}
      \end{columns}
  \end{frame}
